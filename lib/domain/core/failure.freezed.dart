...
class _$ValueFailureTearOff {
  ...
  InvalidEmail<T> invalidEmail<T>({@required T failedValue, int max}) {
  ...
  ExceedingLength<T> exceedingLength<T>({@required T failedValue, int max}) {
...
mixin _$ValueFailure<T> {
  ...
  Result when<Result extends Object>({
    @required Result invalidEmail(T failedValue, int max),
  ...
  Result maybeWhen<Result extends Object>({
    Result invalidEmail(T failedValue, int max),
...
class _$InvalidEmail<T> implements InvalidEmail<T> {
  const _$InvalidEmail({@required this.failedValue, this.max})
...
abstract class InvalidEmail<T> implements ValueFailure<T> {
  const factory InvalidEmail({@required T failedValue, int max}) =
      _$InvalidEmail<T>;
...
class _$ExceedingLength<T> implements ExceedingLength<T> {
  const _$ExceedingLength({@required this.failedValue, this.max})
      : assert(failedValue != null);
...
abstract class ExceedingLength<T> implements ValueFailure<T> {
  const factory ExceedingLength({@required T failedValue, int max}) =
      _$ExceedingLength<T>;
